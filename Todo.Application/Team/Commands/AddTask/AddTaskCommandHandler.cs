...
internal class AddTaskCommandHandler : IRequestHandler<AddTaskCommand>
{
    ...
    public AddTaskCommandHandler(ITodoRepository todoRepository, ITeamRepository teamRepository, IAuthorization<TeamEntity> authorization)
    {
