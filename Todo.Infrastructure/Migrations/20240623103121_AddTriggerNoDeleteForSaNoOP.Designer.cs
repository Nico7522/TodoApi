...
namespace Todo.Infrastructure.Migrations
{
    ...
    [Migration("20240623103121_AddTriggerNoDeleteForSaNoOP")]
    partial class AddTriggerNoDeleteForSaNoOP
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Todo.Domain.Entities.TodoEntity", b =>
                {
                    ...
                    b.Property<DateOnly>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("date")
                        .HasDefaultValue(new DateOnly(2024, 6, 23));
            ...
            modelBuilder.Entity("Todo.Domain.Entities.UserEntity", b =>
                {
                    ...
                    b.ToTable("AspNetUsers", null, t =>
                        {
                            t.HasTrigger("SANoDeleteTrigger");
                        });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Todo.Domain.Entities.UserEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Todo.Domain.Entities.TeamEntity", b =>
                {
                    b.HasOne("Todo.Domain.Entities.UserEntity", "Leader")
                        .WithOne("LeadedTeam")
                        .HasForeignKey("Todo.Domain.Entities.TeamEntity", "LeaderId");
